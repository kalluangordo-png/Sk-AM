...
// --- CONFIGURAÇÃO DE ENTREGA (GPS) ---
// Endereço: Tv. Caxias, 21 - Nova Cidade, Manaus - AM
export const DELIVERY_SETTINGS = {
  storeLat: -3.0068, 
  storeLng: -59.9799, 
  pricePerKm: 1.50, // Preço por KM extra (acima de 7km)
  minFee: 5.00,     // Taxa base
};

// --- DADOS PADRÃO (CARDÁPIO) ---
...
export const INITIAL_MENU = [
  {
    ...
    description: "Pão brioche macio, 1 smash de carne (70g), queijo derretido e Maionese Secreta SK.",
    priceSolo: 16.9,
    priceCombo: 26.9,
    ...
    available: true,
    stock: 100,
    options: [{ name: "Ponto da Carne", type: "radio", items: ["Ao Ponto", "Bem Passado"], required: true }, OPCOES_EXTRAS],
  },
  {
    id: 2,
    category: "LINHA SMASH",
    name: "SK SALAD (O Fresquinho)",
    description: "Pão brioche, 1 smash de carne (70g), queijo, alface americana crocante, tomate e cebola roxa.",
    priceSolo: 18.9,
    priceCombo: 28.9,
  ...
  },
  {
    ...
    description: "Pão brioche, 2 carnes smash (sabor em dobro!), dobro de queijo cheddar e bacon em cubos crocantes.",
    priceSolo: 22.9,
    priceCombo: 32.9,
  ...
  },
  {
    ...
    description: "Pão brioche, carne alta 150g, queijo coalho tostado, fatias de banana pacovã frita e um fio de melaço.",
    priceSolo: 29.9,
    priceCombo: 39.9,
  ...
  },
  {
    ...
    description: "Pão brioche, carne alta 150g, Creme de Gorgonzola Artesanal e cebola roxa caramelizada.",
    priceSolo: 29.9,
    priceCombo: 39.9,
  ...
  },
  {
    ...
    description: "Pão brioche, carne alta 150g, queijo cheddar, fatias de bacon, ovo frito, alface, tomate e molho especial.",
    priceSolo: 32.9,
    priceCombo: 42.9,
...
export const INITIAL_BAIRROS = [
  { id: 1, nome: "Nova Cidade", taxa: 5.0 }, // Bairro da loja
  { nome: "Cidade Nova", taxa: 7.0 },
  { nome: "Novo Aleixo", taxa: 10.0 },
